...
def make_det_plots(det, strain_L1_whitenbp, template_match, strain_H1_whitenbp, time, timemax, SNR, eventname, plottype, tevent, template_fft, datafreq, freqs, data_psd, fs, d_eff, pcolor, strain_whitenbp):
